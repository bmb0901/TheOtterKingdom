...
public class OtterWizardModel extends ModelBase {
	...
	public OtterWizardModel() {
		...
		head.addChild(hat);
		hat.cubeList.add(new ModelBox(hat, 18, 8, -5.0F, -13.8619F, -0.0224F, 6, 1, 7, 0.0F, false));
		hat.cubeList.add(new ModelBox(hat, 18, 8, -3.0F, -22.6305F, 2.1313F, 2, 5, 2, 0.0F, false));
		hat.cubeList.add(new ModelBox(hat, 18, 8, -4.0F, -18.8156F, 1.4313F, 4, 5, 4, 0.0F, false));
